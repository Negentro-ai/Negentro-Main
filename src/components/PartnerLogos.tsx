...
export const PartnerLogos: React.FC = () => {
  ...
  const logoList = [
    { component: <NotionLogo className="h-7 sm:h-8 md:h-[34px] w-auto max-h-[34px]" />, name: 'Notion' },
    { component: <ClaudeLogo className="h-6 sm:h-7 md:h-[28px] w-auto max-h-[28px]" />, name: 'Claude' },
    { component: <ModalLogo className="h-5 sm:h-6 md:h-[25px] w-auto max-h-[25px]" />, name: 'Modal' },
    { component: <MongoDbLogo className="h-7 sm:h-8 md:h-[34px] w-auto max-h-[34px]" />, name: 'MongoDB' },
  ]
  ...
  return (
    <div className="w-full py-0 overflow-hidden shrink-0">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
        ...
        <p className="max-w-[1024px] mx-auto text-base sm:text-xl md:text-[24px] leading-[28px] sm:leading-[34px] md:leading-[40px] font-thin font-[100] tracking-[0px] text-black uppercase mb-3 sm:mb-4 select-none">
